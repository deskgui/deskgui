...
namespace deskgui::event {
  ...
  class Event {
  public:
    explicit Event(bool cancellable = false) : cancellable_(cancellable) {}
  ...
  struct WindowShow : Event {
    explicit WindowShow(bool show) : Event(true), state(show) {}
  ...
  struct WindowResize : Event {
    explicit WindowResize(const ViewSize& viewSize) : Event(true), size(viewSize) {}
  ...
  struct WebviewOnMessage : Event {
    explicit WebviewOnMessage(const std::string& msg) : Event(true), message(msg) {}
  ...
  struct WebviewNavigationStarting : Event {
    explicit WebviewNavigationStarting(const std::string& urlArg) : Event(true), url(urlArg) {}
  ...
  struct WebviewFrameNavigationStarting : Event {
    explicit WebviewFrameNavigationStarting(const std::string& urlArg) : Event(true), url(urlArg) {}
    const std::string url;
  };
  ...
  struct WebviewSourceChanged : Event {
    explicit WebviewSourceChanged(const std::string& src) : Event(false), source(src) {}
  ...
  struct WebviewContentLoaded : Event {
    explicit WebviewContentLoaded(bool loaded) : Event(false), state(loaded) {}
